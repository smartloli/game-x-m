 ...
 */
package org.smartloli.game.x.m.book._2_3;
...
public class WordCount {
	...
	private static void run(String name) throws Exception {
		...
		// 设置统计文件在分布式文件系统中的路径
		String tmpLocalIn = SystemConfig.getProperty("game.x.hdfs.standlone.input.path");
		String inPath = String.format(tmpLocalIn, name);
		// 设置输出结果在分布式文件系统中的路径
		String tmpLocalOut = SystemConfig.getProperty("game.x.hdfs.standlone.output.path");
